package perscholas.module303.lesson01;
...
public class CoreJavaVariables {
	...
	public static void main(String[] args) {
		...
		// Program 1
		System.out.println(CoreJavaVariables.addInts(2, 5));  
		
		// Program 2
		System.out.println(CoreJavaVariables.addDoubles(2.50, 6.25)); 
		
		// Program 3
		System.out.println(CoreJavaVariables.addIntDouble(2, 19.25));  
		
		// Program 4a
		System.out.println(CoreJavaVariables.divideInts(4, 12));  
		// Program 4b
		// Following code causes error. First 12.50 is not an integer. 
		// System.out.println(JavaBasicsClass.divideInts(12.50, 4));  
		
		// Program 5
		System.out.println((int)CoreJavaVariables.divideDoubles(45.60, 3.25));
		
		// Program 6
		double q = CoreJavaVariables.divideInts(5, 6);
		...
		// Program 7
		final int seven = 7;
		System.out.println(CoreJavaVariables.addIntDouble(seven, 19.25));
